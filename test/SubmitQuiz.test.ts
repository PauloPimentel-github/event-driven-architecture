...
test("Um usuário deve submeter um quiz respondido e a nota deve ser calculada e uma notificação por e-mail deve ser enviada", async () => {
  ...
  expect(mailer.messages[0].message).toBe("Olá Paulo Pimentel, sua nota do quiz é 100");
});
